...
library SignatureUtils {
    ...
    function verifyMessageSignedForPreRegistrationUsername(
        ...
        return SignatureRecover.signatureVerification(
            ...
            string.concat(AdvancedStrings.bytes32ToString(_hashUsername), ",", Strings.toString(_nameServiceNonce)),
            signature,
            signer
        );
    }
    ...
    function verifyMessageSignedForRegistrationUsername(
        ...
        return SignatureRecover.signatureVerification(
            ...
            string.concat(_username, ",", Strings.toString(_clowNumber), ",", Strings.toString(_nameServiceNonce)),
            signature,
            signer
        );
    }
    ...
    function verifyMessageSignedForWithdrawOffer(
        ...
        return SignatureRecover.signatureVerification(
            Strings.toString(evvmID),
            "withdrawOffer",
            string.concat(_username, ",", Strings.toString(_offerId), ",", Strings.toString(_nameServiceNonce)),
            signature,
            signer
        );
    }
    ...
    function verifyMessageSignedForRenewUsername(
        ...
        return SignatureRecover.signatureVerification(
            Strings.toString(evvmID),
            "renewUsername",
            string.concat(_username, ",", Strings.toString(_nameServiceNonce)),
            signature,
            signer
        );
    }
    ...
    function verifyMessageSignedForAddCustomMetadata(
        ...
        return SignatureRecover.signatureVerification(
            Strings.toString(evvmID),
            "addCustomMetadata",
            string.concat(_identity, ",", _value, ",", Strings.toString(_nameServiceNonce)),
            signature,
            signer
        );
    }
    ...
    function verifyMessageSignedForRemoveCustomMetadata(
        ...
        return SignatureRecover.signatureVerification(
            ...
            string.concat(_username, ",", Strings.toString(_key), ",", Strings.toString(_nonce)),
            signature,
            signer
        );
    }
